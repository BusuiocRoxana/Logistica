...
public class ChartActivity extends DemoBase implements SeekBar.OnSeekBarChangeListener,
    ...
    private ArrayList<CerereOferta> cereriOferta = new ArrayList<>();
...
*/
    ...
    private void setData(int count, float range) {
        ...
        try {
            cereriOferta = databaseHelper.selectCereriOferta();

        } catch (ParseException e) {
            e.printStackTrace();
        }
        for(int i=0;i<cereriOferta.size();i++){
            yVals1.add(new BarEntry(i,(float)(cereriOferta.get(i).getCantitate())*
                    (float)cereriOferta.get(i).getPret(),
                    cereriOferta.get(i).getMaterial().getDenumire_material()));
        }
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Cereri Oferta 2017");
